...
export const SUPPLIER_KEY_TYPE_OPTIONS: Option[] = [
  { value: "CPF", label: "CPF" },
...
export const RESOURCES: ResourceDef[] = [
  ...
  },
  {
    ...
    singular: "Fornecedor",
    plural: "Fornecedores",
    description: "Fornecedores e prestadores de serviço para baixa de despesas",
    viewPermission: "fornecedores.view",
    createPermission: "fornecedores.create",
    editPermission: "fornecedores.edit",
    deletePermission: "fornecedores.delete",
    canCreate: true,
    canDelete: true,
    standalone: true,
    fields: [
      { key: "name", label: "Nome/Razão social", type: "text", required: true },
      { key: "cpfCnpj", label: "CPF/CNPJ", type: "text", hint: "Somente números" },
      { key: "phone", label: "Telefone", type: "text" },
      { key: "email", label: "E-mail", type: "text" },
      { key: "address", label: "Endereço", type: "text" },
      { key: "pix", label: "Chave PIX", type: "text" },
      {
        ...
        type: "select",
        options: SUPPLIER_KEY_TYPE_OPTIONS,
      },
  ...
  },
  {
    ...
    singular: "Entrada",
    plural: "Entradas",
    description: "Receitas diversas com lançamento automático no caixa",
    viewPermission: "entradas.view",
    createPermission: "entradas.create",
    editPermission: "entradas.edit",
    deletePermission: "entradas.cancel",
    canCreate: true,
    canDelete: true,
    standalone: true,
    fields: [
      ...
      { key: "document", label: "Documento", type: "text", hint: "Ex.: recibo, nota fiscal" },
      {
        key: "costCenterId",
        label: "Centro de custo",
        type: "relation",
  ...
  },
  {
    ...
    singular: "Saída",
    plural: "Saídas",
    description: "Despesas com controle de baixa e cancelamento",
    viewPermission: "saidas.view",
    createPermission: "saidas.create",
    editPermission: "saidas.edit",
    deletePermission: "saidas.cancel",
    canCreate: true,
    canDelete: true,
    standalone: true,
    actions: [
      { key: "baixar", label: "Baixar", permission: "saidas.baixar" },
      { key: "cancelar", label: "Cancelar", permission: "saidas.cancel" },
    ],
    fields: [
      {
        key: "congregationId",
      ...
      { key: "date", label: "Data (competência)", type: "date", required: true },
      { key: "dueDate", label: "Vencimento", type: "date" },
      {
        key: "supplierId",
        label: "Fornecedor",
        type: "relation",
        relation: { resourceKey: "fornecedores", valueField: "id", labelField: "name" },
      },
      { key: "beneficiary", label: "Beneficiário (avulso)", type: "text" },
      { key: "description", label: "Descrição", type: "text", required: true },
      { key: "value", label: "Valor", type: "decimal", required: true },
      {
        key: "paymentMethod",
      ...
      { key: "observation", label: "Observação", type: "textarea" },
      { key: "status", label: "Situação", type: "select", options: EXPENSE_STATUS_OPTIONS, readonly: true },
    ],
  },
];
